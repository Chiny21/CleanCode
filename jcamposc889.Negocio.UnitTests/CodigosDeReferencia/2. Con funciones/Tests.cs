...
using jcamposc889.Negocio.CodigosDeReferencia.ConFunciones;

namespace jcamposc889.Negocio.CodigosDeReferencia.UnitTests.ConFunciones
{
    [TestClass]
    public class GenereElCodigoDeReferencia_Tests
    {
        ...
        public void GenereElCodigoDeReferencia_GeneraDosVerificadores_TruncaUnDigito()
        {
            ...
            elResultadoObtenido = Calculos.GenereElCodigoDeReferencia(new DateTime(2000, 11, 11), "333", "22", "888888888888");
        ...
        public void GenereElCodigoDeReferencia_ClienteTieneMenosDigitos_PrecedeConCero()
        {
            ...
            elResultadoObtenido = Calculos.GenereElCodigoDeReferencia(new DateTime(2000, 11, 11), "33", "22", "888888888888");
        ...
        public void GenereElCodigoDeReferencia_SistemaTieneUnSoloDigito_PrecedeConCero()
        {
            ...
            elResultadoObtenido = Calculos.GenereElCodigoDeReferencia(new DateTime(2000, 11, 11), "333", "2", "888888888888");
        ...
        public void GenereElCodigoDeReferencia_MesTieneUnSoloDigito_PrecedeConCero()
        {
            ...
            elResultadoObtenido = Calculos.GenereElCodigoDeReferencia(new DateTime(2000, 1, 11), "333", "22", "888888888888");
        ...
        public void GenereElCodigoDeReferencia_DiaTieneUnSoloDigito_PrecedeConCero()
        {
            ...
            elResultadoObtenido = Calculos.GenereElCodigoDeReferencia(new DateTime(2000, 11, 1), "333", "22", "888888888888");
        ...
        public void GenereElCodigoDeReferencia_elConsecutivoTieneMenosDigitos_PrecedeConCeros()
        {
            ...
            elResultadoObtenido = Calculos.GenereElCodigoDeReferencia(new DateTime(2000, 11, 11), "333", "22", "4");
