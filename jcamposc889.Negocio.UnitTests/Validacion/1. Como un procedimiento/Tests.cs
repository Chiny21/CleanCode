...
using jcamposc889.Negocio.Validacion.ComoUnProcedimiento;

namespace jcamposc889.Negocio.UnitTests.Validacion.ComoUnProcedimiento_Tests
{
    [TestClass]
    public class Tests
    {
        ...
        public void ValideLosDatos_TodosLosDatosValidos_True()
        {
            ...
            elResultadoObtenido = Calculos.ValideLosDatos(elValorFacial, elValorTransadoNeto,
