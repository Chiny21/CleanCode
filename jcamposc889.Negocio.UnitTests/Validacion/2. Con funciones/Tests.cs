...
using jcamposc889.Negocio.Validacion.ConFunciones;

namespace jcamposc889.Negocio.UnitTests.Validacion.ConFunciones_Tests
{
    [TestClass]
    public class Tests
    {
        ...
        public void ValideLosDatos_TodosLosDatosValidos_True()
        {
            ...
            elResultadoObtenido = Calculos.VerifiqueLosDatos(elValorFacial, elValorTransadoNeto,
