...
namespace jcamposc889.Negocio.UnitTests.EstructuraDeDatos.ConObjetos.TasasBrutasSinTratamiento
{
    [TestClass]
    public class ComoNumeroConTratamiento_Tests
    {
        ...
        public void ComoNumero_DatosCorrectos_TasaBrutaCorrecta()
        {
            ...
            elResultadoObtenido = new TasaBrutaSinTratamiento(elValorFacial, elValorTransadoNeto, laTasaDeImpuesto, laFechaActual, laFechaDeVencimiento).ComoNumero();
