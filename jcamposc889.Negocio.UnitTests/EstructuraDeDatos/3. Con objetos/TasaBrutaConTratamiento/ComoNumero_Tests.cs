...
namespace jcamposc889.Negocio.UnitTests.EstructuraDeDatos.ConObjetos.TasasBrutasConTratamiento
{
    [TestClass]
    public class ComoNumeroConTratamiento_Tests
    {
        ...
        public void ComoNumero_DatosCorrectos_TasaBrutaCorrecta()
        {
            ...
            elResultadoObtenido = new TasaBrutaConTratamiento(elValorFacial, elValorTransadoNeto, laTasaDeImpuesto, laFechaActual, laFechaDeVencimiento).ComoNumero();
