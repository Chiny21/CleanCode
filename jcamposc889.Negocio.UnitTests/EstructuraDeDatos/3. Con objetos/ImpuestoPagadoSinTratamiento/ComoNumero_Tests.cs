...
namespace jcamposc889.Negocio.UnitTests.EstructuraDeDatos.ConObjetos.ImpuestosPagadosSinTratamiento
{
    [TestClass]
    public class ComoNumeroSinTratamiento_Tests
    {
        ...
        public void ComoNumero_DatosCorrectos_ImpuestoPagadoCorrecto()
        {
            ...
            elResultadoObtenido = new ImpuestoPagadoSinTratamiento(elValorFacial, elValorTransadoNeto, laTasaDeImpuesto, laFechaActual, laFechaDeVencimiento).ComoNumero();
