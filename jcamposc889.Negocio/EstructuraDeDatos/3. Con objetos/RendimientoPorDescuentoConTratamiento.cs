...
namespace jcamposc889.Negocio.EstructuraDeDatos.ConObjetos
{
    public class RendimientoPorDescuentoConTratamiento
    {
        ...
        public RendimientoPorDescuentoConTratamiento(double elValorFacial, double elValorTransadoNeto, double laTasaDeImpuesto, DateTime laFechaActual, DateTime laFechaDeVencimiento)
        {
